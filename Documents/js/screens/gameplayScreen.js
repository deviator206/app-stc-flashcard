...
GamePlayScreen.prototype.setUp = function() {
	...
	//console.log(' ' +this.mApplication.nQuestionIndex + ' :: '+config.questionSet.length);
	//console.log(' : '+config.questionSet[this.mApplication.nQuestionIndex].question);
	var sContent = '<div id="game_screen_logo_2" class="gameScreenLogo"></div><div id= "imgHolder_In_Question" class="gameImg"></div><div class="questionTxt"><p>' + config.questionSet[this.mApplication.nQuestionIndex].question;
	sContent += '</p></div><div class="answerDiv">	<div id="option_1" class="ans"><div style="width:10px;">A.</div><div style="margin-top: -15px;margin-left: 20px;"> ' + config.questionSet[this.mApplication.nQuestionIndex].option_1
	sContent += '</div> </div><div class="ansSpace"></div><div id="option_2" class="ans"><div style="width:10px;">B.</div><div style="margin-top: -15px;margin-left: 20px;"> ' + config.questionSet[this.mApplication.nQuestionIndex].option_2
	sContent += '</div> </div><div class="ansSpace"></div> <div id="option_3" class="ans"><div style="width:10px;">C.</div><div style="margin-top: -15px;margin-left: 20px;"> ' + config.questionSet[this.mApplication.nQuestionIndex].option_3
	sContent += '</div> </div><div class="ansSpace"></div><div id="option_4" class="ans"><div style="width:10px;">D.</div><div style="margin-top: -15px;margin-left: 20px;"> ' + config.questionSet[this.mApplication.nQuestionIndex].option_4
	...
	//console.log(' imgURL :: ' +config.questionSet[this.mApplication.nQuestionIndex].img_url);
